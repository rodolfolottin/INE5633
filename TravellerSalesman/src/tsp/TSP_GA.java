...
public class TSP_GA {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("2 - Roulette Selection");
        int algorithm = scanner.nextInt();

        if (algorithm == 1) {
        	tournamentSelection = true;
        	System.out.println("Tournament Selection it is!");
        } else {
        	tournamentSelection = false;
        	System.out.println("Roulette Selection it is!");
        }
        ...
        pop = GA.evolvePopulation(pop, tournamentSelection);
        for (int i = 0; i < 100; i++) {
            pop = GA.evolvePopulation(pop, tournamentSelection);
        }
        ...
        System.out.println("Dif: " + (initialDistance - finalDistance));
